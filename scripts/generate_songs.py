    ...
    for item in kg.get("items", []):
        ...
        if slug:
            ...
            emit(slug, {
                ...
                "tweets": item.get("tweets", []), "snsTweets": item.get("snsTweets", []), "spotify": item.get("spotify", ""),
        ...
        if coupling and coupling.get("slug"):
            ...
            emit(c["slug"], {
                ...
                "tweets": c.get("tweets", []), "snsTweets": c.get("snsTweets", []), "spotify": c.get("spotify", ""),
        ...
        for t in a.get("tracks", []):
            ...
            if slug:
                emit(slug, {
                    ...
                    "tweets": t.get("tweets", []), "snsTweets": t.get("snsTweets", []), "spotify": t.get("spotify", ""),
